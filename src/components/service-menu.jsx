          ...
          <div className="grid grid-cols-2 gap-2">
            {quickLinks.map((link, idx) => (
              <Link
                ...
                className={`${expandAnimationClass} flex flex-row items-center gap-2 rounded-2xl p-3 min-h-[70px] transition-all duration-300 ease-out active:scale-95 group ${
                  isActive(link.href)
                    ...
                    : "bg-white/70 dark:bg-white/5 border border-black/5 dark:border-white/10 text-secondaryDark dark:text-secondaryLight hover:bg-main-1/10 dark:hover:bg-main-1/20 hover:border-main-1/20"
                }`}
              ...
              >
                {/* Icon */}
                <div
                  className={`text-lg p-2 bg-main-2/10 rounded-full transition-all duration-300 ${
                    isActive(link.href)
          ...
          <div className="space-y-1.5">
            {hrServicesMenu.map((el, idx) => (
              <Link
                ...
                onClick={handleServiceClick}
                style={{
                  transitionDelay: `${quickLinks.length * 25 + idx * 20}ms`,
                }}
                className={`${expandAnimationClass} flex items-center gap-3 rounded-2xl px-4 py-3 bg-white/70 dark:bg-white/5 border border-black/5 dark:border-white/10 text-secondaryDark dark:text-secondaryLight hover:bg-main-1/5 dark:hover:bg-main-1/10 hover:border-main-1/20 transition-all duration-300 ease-out active:scale-[0.98] group`}
          ...
          <div className="col-span-4">
            <div className="flex items-center justify-between">
              ...
              <Link
                href="/services"
                onClick={handleViewAllClick}
                className="font-bold px-3 py-2 bg-main-2 dark:bg-main-1/30 text-secondaryDark dark:text-secondaryLight rounded-full text-xs duration-300 ease-in-out hover:bg-main-1 text-white dark:hover:bg-main-2 dark:hover:text-secondaryDark"
              >
                View All Services
              </Link>
            </div>
            <div className="mt-2 grid grid-cols-3 gap-2">
              {hrServicesMenu.map((el, idx) => (
                <Link
                  ...
                  className={`${expandAnimationClass} flex gap-3 rounded-main p-4 bg-lightColor/30 dark:bg-darkColor/30 text-white dark:text-dark-color hover:bg-main-2/10 dark:hover:bg-main-1/10 transition-all duration-300 ease-in-out transform hover:scale-[1.02] relative group`}
